...
?>  
  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6 mt-auto">
      ...
      <input type="name" name="projectname" class="form-control" id="name">
    </div>
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6 mt-auto">
      <label for="name">Project Name</label>
      <input type="name" name="projectname" value="<?=$data2['projectname']?>" class="form-control" id="name">
    </div>
    ...
    <div class="form-group col-md-12">
      <label for="email">Project Link</label>
      <input type="text" name="projectlink" value="<?=$data2['projectlink']?>" class="form-control" id="email" >
    </div>
