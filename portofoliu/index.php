                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            <div class="address">
                                ...
                                <a href="https://goo.gl/maps/1nwoDAQ8cBY9inaE6"><h4>Location:</h4>
                                <p><?=$data['location']?></p>
                                </a>
                            </div>
                            ...
                            <div class="phone">
                                ...
                                <a href="tel:+37367595160"><h4>Call:</h4>
                                <p><?=$data['mobile']?></p>
                            </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                        <form action="include/message.php" method="post" role="form" class="php-email-form">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="message" id="message" rows="10" data-rule="required" data-msg="Please write something for me"></textarea>
                                <div class="validate"></div>
                            </div>
                            <div class="mb-3">
...
-->
    ...
    <footer id="footer">
        <div class="container">
            ...
            <div class="credits">
                Developed by <a href="https://ilies-vlad.netlify.app/#">Ilies Vlad</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
